  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."SlidePaths" =
        "${pkgs.libsForQt5.breeze-qt5.bin}/share/wallpapers,/run/current-system/sw/share/wallpapers";
      ...
      "kwinrc"."NightColor"."LatitudeAuto" = 38.3;
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.27.Wallpaper.org.kde.image.General"."Image" =
        "file://${pkgs.libsForQt5.breeze-qt5.bin}/share/wallpapers/Next/contents/images/3840x2160.jpg";
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.29.Wallpaper.org.kde.image.General"."Image" =
        "file://${pkgs.libsForQt5.breeze-qt5.bin}/share/wallpapers/Next/contents/images/1920x1080.jpg";
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.31.Applets.34.Configuration.General"."launchers" =
        "applications:systemsettings.desktop,applications:firefox.desktop,applications:org.gnome.DiskUtility.desktop,preferred://filemanager,applications:com.obsproject.Studio.desktop,applications:olive.desktop,applications:org.gnome.Terminal.desktop,applications:steam.desktop,applications:org.kde.krdc.desktop,applications:google-chrome.desktop,applications:emacs.desktop,applications:keybase.desktop";
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" =
        "${wallpaper-large},${wallpaper-small}";
