# Generated by Powerlevel10k configuration wizard on 2024-12-05 at 11:27 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=( kubecontext terraform aws nix_shell status
  ...
  typeset -g POWERLEVEL9K_AWS_CONTENT_EXPANSION='${P9K_AWS_REGION:+ ${P9K_AWS_REGION//\%/%%}}'
