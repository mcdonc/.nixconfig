...
# assume boot is on separate device (/dev/sdc1)
...
# assume boot is on /dev/sdc1 (pre-prepared)
mount /dev/disk/by-id/ata-Samsung_SSD_850_EVO_1TB_S21CNXAG619917K-part1 /mnt/boot
